...
genome=/sonas-hs/gillis/hpc/home/sballouz/STAR/GRCh38_Gencode24_v2/
...
$STAR --genomeDir $genome --readFilesIn $read1 $read2 --readFilesCommand $readComm --runThreadN 5 $STARoptions
