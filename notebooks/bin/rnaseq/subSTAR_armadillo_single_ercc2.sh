...
genome=/sonas-hs/gillis/hpc/home/sballouz/sballouz/armadillo/ensembl/dasNov3.0.95/
...
$STAR --genomeDir $genome --readFilesIn $read1 --readFilesCommand $readComm --runThreadN 1 $STARoptions
